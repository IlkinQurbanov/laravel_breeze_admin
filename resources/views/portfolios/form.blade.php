        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <form method="post" action="{{ isset($portfolio) ? route('portfolios.update', $portfolio->id) : route('portfolios.store') }}" class="mt-6 space-y-6" enctype="multipart/form-data">
                        @csrf
                        @method('POST')
                        ...
                        <div>
                            ...
                            <x-text-input id="name" name="name" type="text" class="mt-1 block w-full" :value="$portfolio->name ?? old('name')" required autofocus />
